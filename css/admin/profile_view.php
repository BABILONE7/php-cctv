				...
				<form action="" method="post" name="detailmem" onSubmit="JavaScript:return addlocation();" enctype="multipart/form-data" onSubmit="JavaScript:return addlocation();">
					<div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-4">
								<label class="col-sm-3 text-left control-label col-form-label"><a href="../admin/profile_edit.php?editmem=<?php echo $_SESSION["m_id"];?>"><button type="button" class="btn btn-outline-primary">แก้ไขข้อมูลส่วนตัว</button></a></label>	
								<br>
