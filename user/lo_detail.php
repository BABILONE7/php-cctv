                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["lo_name"];?></label>
                                        </div>
                                    </div>
                                        ...
                                        <thead>
                                           ...
                                           <tr role="row">
												...
												<th class="sorting" tabindex="0" aria-controls="zero_config" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 150px;">ครั้งที่ซ่อม</th>
