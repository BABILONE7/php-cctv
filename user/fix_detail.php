...
<?php
  ...
  include('..//connection.php');
   ...
   if(isset($_GET["viewfix"]))
   {
	   $fix = $_GET["viewfix"];
   }

   $sql = "SELECT * FROM fixing WHERE f_id = '".$fix."' ";
...
<div id="main-wrapper" data-sidebartype="mini-sidebar">
		...
		<div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">ราละเอียดข้อมูลกล้องวงจรปิดที่เสียหาย</h5>

                                     <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">รหัสประจำเครื่อง :</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_idnum"];?></label>
										 </div>
                                    </div>
                                  ...
                                  <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_name"];?></label>
                                        </div>
                                    </div>
								<div class="form-group row">
            						<label class="col-sm-3 text-right control-label col-form-label">IP Camera</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_ip"];?></label>
                                        </div>
                                  </div>
                                  <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">Port</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_port"];?></label>
                                        </div>
                                    </div>
								<div class="form-group row">
            						<label class="col-sm-3 text-right control-label col-form-label">ยี่ห้อเครื่อง</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_brand"];?></label>
                                        </div>
                                  </div>
									 <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">Serial Number</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_sn"];?></label>
                                        </div>
                                    </div>
								  <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">เลขพัสดุ</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_tax"];?></label>
                                        </div>
                                  </div>

									<div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">วันที่เสีย</label>
                                        <div class="col-sm-6">
                                        <label class="col-sm-6 text-left control-label col-form-label"><?php echo date('d-m-Y',strtotime($result["f_import"]));?></label>
                                        </div>
                                    </div>
  					  <div class="form-group row">
						...
						<label class="col-sm-3 text-right control-label col-form-label">สถานที่ติดตั้ง</label>
                                        <div class="col-md-6">
                                        <label class="col-sm-4 text-left control-label col-form-label"><?php echo $result["f_place"];?></label>

                                    </div>
                      </div>

                                    <div class="form-group row">
                                        <label class="col-sm-3 text-right control-label col-form-label">สาเหตุ</label>
                                        <div class="col-sm-6">
                                            <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_note"];?></label>
                                        </div>
                                    </div>

									<div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">สถานที่ซ่อม</label>
                                    <div class="col-md-6">
                                     <label class="col-sm-3 text-left control-label col-form-label"><?php echo $result["f_fix_place"];?></label>
                                    </div>
                                </div>
                               </div>
